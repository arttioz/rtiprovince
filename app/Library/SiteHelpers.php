	...
	public static function showUploadedFile($file,$path , $width = 80) {
		...
		//	echo $files ;
			...
			if($info['extension'] == "jpg" || $info['extension'] == "jpeg" ||  $info['extension'] == "png" || $info['extension'] == "gif" || $info['extension'] == "JPG") 
			{
				...
				<img src="'.asset( $path_file . $file ).'" border="0" width="'. $width .'" /></a></p>';
...
//			return "<img src='".asset('/uploads/images/no-image.png')."' border='0' width='".$width."' class='img-circle' /></a>";
	...
	{
		$avatar = '<img alt="" src="http://www.gravatar.com/avatar/'.md5(session('eid')).'" width="'.$width.'" />';
//		$avatar = '<img alt="" src="http://www.gravatar.com/avatar/'.md5(session('eid')).'" class="img-circle" width="'.$width.'" />';
		...
		if(count($Q)>=1) 
		{
			...
			if($row->avatar !='' ) 	
			{
				...
				{
					return  '<img src="'.asset('uploads/users').'/'.$row->avatar.'" border="0" width="'.$width.'" style="max-height: 50px;" />';
