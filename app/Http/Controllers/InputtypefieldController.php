...
use App\Models\Inputtypefield;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class InputtypefieldController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'inputtypefield';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Inputtypefield();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'inputtypefield',
	...
	public static function display(  )
	{
		...
		$model  = new Inputtypefield();
		$info = $model::makeInfo('inputtypefield');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('inputtypefield.public.view',$data);			
			}			
		} 
		else {
			...
			return view('inputtypefield.public.index',$data);	
		}
