...
class DeadconsohistoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'deadconsohistory';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Deadconsohistory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'deadconsohistory',
...
//        $deadconsohistorys = $deadconsohistorys->paginate(10);
	...
	public static function display(  )
	{
		...
		$model  = new Deadconsohistory();
		$info = $model::makeInfo('deadconsohistory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('deadconsohistory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('deadconsohistory.public.index',$data);	
		}
