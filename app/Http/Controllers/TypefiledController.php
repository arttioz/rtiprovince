...
use App\Models\Typefiled;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class TypefiledController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'typefiled';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Typefiled();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'typefiled',
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('typefiled.public.view',$data);			
			}			
		} 
		else {
			...
			return view('typefiled.public.index',$data);	
		}
