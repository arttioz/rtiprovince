...
(function (O, M) {
    ...
    M(J, "parts/Globals.js", [], function () {
        var c = "undefined" === typeof O ? "undefined" !== typeof window ? window : {} : O, p = c.document,
            y = c.navigator && c.navigator.userAgent || "",
            G = p && p.createElementNS && !!p.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            F = /(edge|msie|trident)/i.test(y) && !c.opera, z = -1 !== y.indexOf("Firefox"),
            r = -1 !== y.indexOf("Chrome"), K = z && 4 > parseInt(y.split("Firefox/")[1], 10);
        return {
            product: "Highcharts",
            version: "7.1.3",
    ...
    M(J, "parts/Utilities.js", [J["parts/Globals.js"]], function (c) {
        ...
        c.timers = [];
        var w = c.charts, n = c.doc, l = c.win;
        ...
        c.Fx.prototype = {
            dSetter: function () {
                var b = this.paths[0], d = this.paths[1], a = [], g = this.now, h = b.length;
                if (1 === g) a = this.toD; else if (h === d.length && 1 > g) for (; h--;) {
                    var e = parseFloat(b[h]);
                    a[h] = isNaN(e) ? d[h] : g * parseFloat("" + (d[h] - e)) + e
                } else a = d;
                this.elem.attr("d", a, null, !0)
            }, update: function () {
                var b = this.elem, d = this.prop, a = this.now,
                    g = this.options.step;
                if (this[d + "Setter"]) this[d + "Setter"](); else b.attr ? b.element && b.attr(d, a, null, !0) : b.style[d] = a + this.unit;
                g && g.call(b, a, this)
            }, run: function (b, d, a) {
                var g = this, h = g.options, e = function (a) {
                    return e.stopped ? !1 : g.step(a)
                }, m = l.requestAnimationFrame || function (a) {
                    setTimeout(a, 13)
                }, u = function () {
                ...
                var d = +new Date, a = this.options, g = this.elem, h = a.complete, e = a.duration, c = a.curAnim;
                if (g.attr && !g.element) b = !1; else if (b || d >= e + this.startTime) {
                    this.now = this.end;
                    this.pos = 1;
                    this.update();
                    var u = c[this.prop] = !0;
                ...
                d = d || "";
                var c = b.startX, u = b.endX, n = -1 < d.indexOf("C"), t = n ? 7 : 3, x, k;
                d = d.split(" ");
                a = a.slice();
                var A = b.isArea, B = A ? 2 : 1;
                n && (g(d), g(a));
                if (c && u) {
        ...
        c.merge = function () {
            var b, d = arguments, a = {}, g = function (a, b) {
                "object" !== typeof a && (a = {});
                D(b, function (d, e) {
        ...
        c.wrap = function (b, d, a) {
            var g = b[d];
            b[d] = function () {
                var b = Array.prototype.slice.call(arguments), d = arguments, c = this;
                c.proceed = function () {
        ...
        c.formatSingle = function (b, d, a) {
            var g = /\.([0-9])/, h = c.defaultOptions.lang;
        ...
        c.numberFormat = function (b, d, a, g) {
            b = +b || 0;
            d = +d;
            var h = c.defaultOptions.lang, e = (b.toString().split(".")[1] ||
                "").split("e")[0].length, m = b.toString().split("e");
            if (-1 === d) d = Math.min(e, 20); else if (!K(d)) d = 2; else if (d && m[1] && 0 > m[1]) {
                var u = d + +m[1];
        ...
        D({map: "map", each: "forEach", grep: "filter", reduce: "reduce", some: "some"}, function (b, d) {
            c[d] = function (a) {
        ...
        c.fireEvent = function (b, d, a, g) {
            ...
            if (n.createEvent && (b.dispatchEvent || b.fireEvent)) {
                ...
                void 0 === d && (d = []);
                void 0 === e && (e = []);
                var g = 0, c = 0, m = d.length + e.length;
        ...
        c.seriesType = function (b, d, a, g, h) {
            var e = c.getOptions(), m = c.seriesTypes;
            e.plotOptions[b] =
                c.merge(e.plotOptions[d], a);
            m[b] = c.extendClass(m[d] || function () {
            }, g);
    ...
    M(J, "parts/Color.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.isNumber, G = p.pInt, F = c.merge;
        c.Color = function (z) {
            ...
            parsers: [{
                ...
                if ((this.input = z = this.names[z && z.toLowerCase ? z.toLowerCase() : ""] || z) && z.stops) this.stops = z.stops.map(function (w) {
                    ...
                    if (z && z.charAt && "#" === z.charAt()) {
                        ...
                        7 === v ? r = [(z & 16711680) >>
                        16, (z & 65280) >> 8, z & 255, 1] : 4 === v && (r = [(z & 3840) >> 4 | (z & 3840) >> 8, (z & 240) >> 4 | z & 240, (z & 15) << 4 | z & 15, 1])
                    }
    ...
    M(J, "parts/SvgRenderer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isObject, K = p.isString, v = p.objectEach,
            D = p.pInt, w = p.splat, n = c.addEvent, l = c.animate, b = c.attr, d = c.charts, a = c.color, g = c.css,
            h = c.createElement, e = c.deg2rad, m = c.destroyObjectProperties, u = c.doc, E = c.extend, t = c.hasTouch,
            x = c.isFirefox, k = c.isMS, A = c.isWebKit, B = c.merge, H = c.noop, q = c.pick,
            f = c.removeEvent, C = c.stop, N = c.svg, T = c.SVG_NS, R = c.symbolSizes, S = c.win;
        ...
        E(L.prototype, {
            ...
            animate: function (a, b, f) {
                var I = c.animObject(q(b, this.renderer.globalAnimation,
                    !0));
                ...
                0 !== I.duration ? (f && (I.complete = f), l(this, a, I)) : (this.attr(a, void 0, f), v(a, function (a, b) {
                    I.step && I.step.call(this, a, {prop: b, pos: 1})
                }, this));
                return this
            },
            complexColor: function (a, b, f) {
                var I = this.renderer, q, d, e, k, g, h, P, m, A, C, N, Q = [], L;
                c.fireEvent(this.renderer, "complexColor", {args: arguments}, function () {
                    ...
                    d && (e = a[d], g = I.gradients, P = a.stops, C = f.radialReference, F(e) && (a[d] =
                        ...
                        }), "radialGradient" === d && C && !y(e.gradientUnits) && (k = e, e = B(e, I.getRadialAttr(C, k), {gradientUnits: "userSpaceOnUse"})), v(e, function (a, I) {
                        "id" !== I && Q.push(I, a)
                    }), v(P, function (a) {
                        Q.push(a)
            ...
            applyTextOutline: function (a) {
                var I = this.element, f;
                -1 !== a.indexOf("contrast") && (a = a.replace(/contrast/g, this.renderer.getContrast(I.style.fill)));
                a = a.split(" ");
                var q = a[a.length - 1];
            ...
            attr: function (a, b, f, q) {
                var I = this.element, d, e = this, g, k, h = this.symbolCustomAttribs;
            ...
            css: function (a) {
                var f = this.styles, I = {}, q = this.element, d = "", e = !f,
                ...
                if (e) {
                    f && (a = E(f, I));
                    if (a) if (null === a.width || "auto" === a.width) delete this.textWidth; else if ("text" === q.nodeName.toLowerCase() && a.width) var c = this.textWidth = D(a.width);
                    this.styles = a;
            ...
            strokeWidth: function () {
                ...
                if (a.indexOf("px") === a.length - 2) a = D(a); else {
            ...
            updateTransform: function () {
                var a = this.translateX || 0, b = this.translateY || 0, f = this.scaleX, d = this.scaleY,
                    e = this.inverted, k = this.rotation, g = this.matrix, c = this.element;
            ...
            getBBox: function (a, b) {
                var f, d = this.renderer, I = this.element, k = this.styles, g = this.textStr, c, h = d.cache,
                    B = d.cacheKeys, P = I.namespaceURI === this.SVG_NS;
                b = q(b, this.rotation);
                var m = b * e;
            ...
            add: function (a) {
                var b = this.renderer, f = this.element;
            ...
            destroy: function () {
                var a =
                        this, b = a.element || {}, f = a.renderer, q = f.isSVG && "SPAN" === b.nodeName && a.parentGroup,
                    d = b.ownerSVGElement, e = a.clipPath;
            ...
            setTextPath: function (a, b) {
                var f = this.element, q = {textAnchor: "text-anchor"}, d = !1, e =
                    this.textPathWrapper, k = !e;
            ...
            zIndexSetter: function (a, b) {
                var f = this.renderer, q = this.parentGroup, d = (q || f).element || f.box, e = this.element, k = !1;
                f = d === f.box;
                var g = this.added;
                var c;
                ...
                if (g) {
                    ...
                    for (c = b.length - 1; 0 <= c && !k; c--) {
                        ...
                        var h = !y(g);
                        if (q !== e) if (0 > a && h && !f && !c) d.insertBefore(e, b[c]), k = !0; else if (D(g) <=
        ...
        E(p.prototype, {
            Element: L, SVG_NS: T, init: function (a, f, q, d, e, k, c) {
                var h = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"});
                c || h.css(this.getStyle(d));
                d = h.element;
                a.appendChild(d);
                b(a, "dir", "ltr");
                -1 === a.innerHTML.indexOf("xmlns") && b(d, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = d;
                this.boxWrapper = h;
                this.alignedObjects = [];
                ...
                x && a.getBoundingClientRect && (f = function () {
                    ...
                    g(a, {left: Math.ceil(I.left) - I.left + "px", top: Math.ceil(I.top) - I.top + "px"})
                }, f(), this.unSubPixelFix = n(S, "resize",
                    f))
            }, definition: function (a) {
                function b(a, q) {
                    var d;
                    w(a).forEach(function (a) {
                        var e = f.createElement(a.tagName), k = {};
                        v(a, function (a, b) {
            ...
            isHidden: function () {
                ...
                b.init(this, a);
                return b
            }, draw: H, getRadialAttr: function (a, b) {
                return {cx: a[0] - a[2] / 2 + b.cx * a[2], cy: a[1] - a[2] / 2 + b.cy * a[2], r: b.r * a[2]}
            }, truncate: function (a, b, f, d, q,
                                   e, k) {
                var g = this, c = a.rotation, h, I = d ? 1 : 0, B = (f || d).length, m = B, A = [], C = function (a) {
                    b.firstChild && b.removeChild(b.firstChild);
                ...
                var f = a.element, d = this, e = d.forExport, k = q(a.textStr, "").toString(),
                    c = -1 !== k.indexOf("<"), h = f.childNodes, B, I = b(f, "x"), m = a.styles, A = a.textWidth,
                    C = m && m.lineHeight, L = m && m.textOutline, t = m && "ellipsis" === m.textOverflow,
                    H = m && "nowrap" === m.whiteSpace, x = m && m.fontSize, n, l = h.length;
                ...
                if (S !== a.textCache) {
                    ...
                    c || L || t || A || -1 !== k.indexOf(" ") && (!H || r.test(k)) ? (m && m.appendChild(f), c ? (k = d.styledMode ? k.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">') : k.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">'), k = k.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(r)) : k = [k], k =
                        ...
                        m.forEach(function (q) {
                            if ("" !== q || 1 === m.length) {
                                var C = {}, L = u.createElementNS(d.SVG_NS, "tspan"), P, l;
                                ...
                                if (" " !== q) {
                                    ...
                                    if (A) {
                                        ...
                                        }); else if (C) for (; Q.length;) Q.length && !H && 0 < l && (L = u.createElementNS(T,
                                            "tspan"), b(L, {
                                            dy: r,
                                            x: I
                ...
                var I = this.label(a, b, f, h, null, null, m, null, "button"), A = 0, C = this.styledMode;
                ...
                var k = {preserveAspectRatio: "none"}, g = function (a, b) {
                ...
                var m = this, B = /^url\((.*?)\)$/, A = B.test(a), C = !A && (this.symbols[a] ? a : "circle"),
                    I = C && this.symbols[C],
                ...
                if (I) {
                    ...
                    ["width", "height"].forEach(function (a) {
                        L[a + "Setter"] = function (a, b) {
                            var f = {}, q = this["img" + b], d = "width" === b ? "translateX" : "translateY";
                            this[b] = a;
                ...
                circle: function (a, b, f, q) {
                    ...
                    return ["M", a + f / 2, b, "L", a + f, b + q / 2, a + f / 2, b + q, a, b + q / 2, "Z"]
                                  ...
                                  b, f, d, e) {
                    var k = e.start, g = e.r || f, c = e.r || d || f, h = e.end - .001;
                    f = e.innerR;
                    d = q(e.open, .001 > Math.abs(e.end - e.start - 2 * Math.PI));
                    var m = Math.cos(k), B = Math.sin(k), A = Math.cos(h);
                    h = Math.sin(h);
                    ...
                    var e = Math.min(d && d.r || 0, f, q), k = e + 6, g = d && d.anchorX;
                    d = d && d.anchorY;
                    ...
                    return c
                                   ...
                                   b, f, q) {
                var d = c.uniqueKey() + "-", e = this.createElement("clipPath").attr({id: d}).add(this.defs);
                ...
                q || (a.xSetter = function (a, b, f) {
                    var q = f.getElementsByTagName("tspan"), d = f.getAttribute(b), e;
                ...
                return {x: -a / 3 * Math.sin(b * e), y: q}
            }, label: function (a, b, q, d, e, k, g, c, h) {
                var m = this, A = m.styledMode, C = m.g("button" !==
                    h && "label"), N = C.text = m.text("", 0, 0, g).attr({zIndex: 1}), t, H, u = 0, x = 3, n = 0, I, l,
                    T, P, w, Q = {}, R, r, S = /^url\((.*?)\)$/.test(d), v = A || S, p = function () {
                ...
                var D = function () {
                    var a = n + x;
                    var b = c ? 0 : r;
                    y(I) && H && ("center" === w || "right" === w) && (a += {center: .5, right: 1}[w] * (I - H.width));
                ...
                g = {
                    css: function (a) {
                        ...
                        return {width: H.width + 2 * x, height: H.height + 2 * x, x: H.x - x, y: H.y - x}
                    }, destroy: function () {
    ...
    M(J, "parts/Html.js",
        [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
            var y = p.defined, G = p.pInt, F = c.attr, z = c.createElement, r = c.css, K = c.extend, v = c.isFirefox,
                D = c.isMS, w = c.isWebKit, n = c.pick, l = c.SVGElement;
            p = c.SVGRenderer;
            var b = c.win;
            K(l.prototype, {
                htmlCss: function (b) {
                    var a = "SPAN" === this.element.tagName && b && "width" in b, d = n(a && b.width, void 0);
                    if (a) {
                        delete b.width;
                        this.textWidth = d;
                        var c = !0
                    ...
                    if (this.added) {
                        var b = this.renderer, a = this.element, g = this.translateX || 0, c = this.translateY || 0,
                            e = this.x || 0, m = this.y || 0, u = this.textAlign || "left",
                            n = {left: 0, center: .5, right: 1}[u], t = this.styles, x = t && t.whiteSpace;
                        ...
                        if ("SPAN" === a.tagName) {
                            ...
                            var k = this.textWidth && G(this.textWidth),
                                A = [t, u, a.innerHTML, this.textWidth, this.textAlign].join(), B;
                            ...
                            B && (/[ \-]/.test(a.textContent || a.innerText) || "ellipsis" === a.style.textOverflow) ? (r(a, {
                                width: k + "px", display: "block", whiteSpace: x ||
                                    "normal"
            ...
            K(p.prototype, {
                getTransformKey: function () {
                    ...
                    var d = this.createElement("span"), e = d.element, m = d.renderer, u = m.isSVG,
                        E = function (a, b) {
                            ["opacity", "visibility"].forEach(function (d) {
                                a[d +
                                "Setter"] = function (e, k, q) {
                                ...
                                g.reverse().forEach(function (a) {
                                    ...
                                    K(a, {
                                        classSetter: function (a) {
                                            ...
                                            g[0].div && d.on.apply({element: g[0].div}, arguments);
                                            return a
    ...
    M(J, "parts/Time.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isObject, F = p.objectEach, z = p.splat, r = c.extend, K = c.merge, v = c.pick,
            D = c.timeUnits, w = c.win;
        c.Time = function (c) {
            this.update(c, !1)
        };
        c.Time.prototype = {
            defaultOptions: {}, update: function (c) {
                var n = v(c && c.useUTC, !0), b = this;
                ...
                (this.variableTimezone = !(n && !c.getTimezoneOffset && !c.timezone)) || this.timezoneOffset ? (this.get = function (d, a) {
                    var g = a.getTime(), c = g - b.getTimezoneOffset(a);
                    a.setTime(c);
                    d = a["getUTC" + d]();
                    a.setTime(g);
                    return d
                }, this.set = function (d, a, g) {
                    if ("Milliseconds" === d || "Seconds" === d || "Minutes" === d && 0 === a.getTimezoneOffset() % 60) a["set" + d](g); else {
                ...
                return this.useUTC && l.getTimezoneOffset ? function (b) {
                ...
                var d = this, a = new this.Date(l), g = this.get("Hours",
                    a), h = this.get("Day", a), e = this.get("Date", a), m = this.get("Month", a),
                    u = this.get("FullYear", a), E = c.defaultOptions.lang, t = E.weekdays, x = E.shortWeekdays,
                    k = c.pad;
                a = c.extend({
                ...
                return G(c, !0) ? c : (c = z(c), {main: c[0], from: c[1], to: c[2]})
            }, getTimeTicks: function (c, l, b, d) {
                var a = this, g = [], h = {};
                var e = new a.Date(l);
                var m = c.unitRange, u = c.count || 1, n;
                d = v(d, 1);
                if (y(l)) {
                    ...
                    t = a.get("FullYear", e);
                    d = a.get("Month", e);
                    var x = a.get("Date", e), k = a.get("Hours",
                        e);
                    l = e.getTime();
    ...
    M(J, "parts/Tick.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = c.correctFloat, z = c.destroyObjectProperties, r = c.fireEvent,
            K = c.merge, v = c.pick, D = c.deg2rad;
        ...
        c.Tick.prototype = {
            addLabel: function () {
                var w = this, n = w.axis, l =
                        n.options, b = n.chart, d = n.categories, a = n.names, g = w.pos,
                    h = v(w.options && w.options.labels, l.labels), e = n.tickPositions, m = g === e[0],
                    u = g === e[e.length - 1];
                ...
                if (x = k && k.list) w.shortenLabel = function () {
                    for (t = 0; t < x.length; t++) if (E.attr({text: n.labelFormatter.call(c.extend(w.formatCtx, {dateTimeLabelFormat: x[t]}))}), E.getBBox().width < n.getSlotWidth(w) - 2 * v(h.padding, 5)) return;
                    E.attr({text: ""})
                };
                if (y(E)) E && E.textStr !== l && (!E.textWidth || h.style && h.style.width || E.styles.width || E.css({width: null}), E.attr({text: l}), E.textPxLength = E.getBBox().width); else {
                ...
                var n = this.axis, l = n.options.labels, b = c.x, d = n.chart.chartWidth, a = n.chart.spacing,
                    g = v(n.labelLeft, Math.min(n.pos, a[3]));
                a = v(n.labelRight, Math.max(n.isRadial ? 0 : n.pos + n.len, d - a[1]));
                var h = this.label, e = this.rotation,
                    m = {left: 0, center: .5, right: 1}[n.labelAlign || h.attr("align")], u = h.getBBox().width,
                    E = n.getSlotWidth(this), t = E, x = 1, k, A = {};
                if (e || "justify" !== v(l.overflow, "justify")) 0 > e && b - m * u < g ? k = Math.round(b / Math.cos(e * D) - g) : 0 < e && b + m * u > a && (k = Math.round((d - b) / Math.cos(e * D))); else if (d = b + (1 - m) * u, b - m * u < g ? t = c.x + t * (1 - m) - g : d > a && (t = a - c.x + t * m, x = -1), t = Math.min(E, t), t < E && "center" === n.labelAlign && (c.x += x * (E - t - m * (E - Math.min(u, t)))), u > t || n.autoRotation && (h.styles || {}).width) k = t;
            ...
            getPosition: function (w, n, l, b) {
                var d = this.axis, a = d.chart, g = b && a.oldChartHeight || a.chartHeight;
                w = {
                ...
                r(this, "afterGetPosition", {pos: w});
                return w
            }, getLabelPosition: function (c, n, l, b, d, a, g, h) {
                var e = this.axis, m = e.transA, u = e.reversed,
                    E = e.staggerLines, t = e.tickRotCorr || {x: 0, y: 0}, x = d.y,
                    k = b || e.reserveSpaceDefault ? 0 : -e.labelOffset * ("center" === e.labelAlign ? .5 : 1), A = {};
                ...
                var b = this.axis, d = b.options, a = this.gridLine, g = {}, h = this.pos, e = this.type,
                    m = v(this.tickmarkOffset, b.tickmarkOffset), u = b.chart.renderer, E = e ? e + "Grid" : "grid",
                    t = d[E + "LineWidth"], x = d[E + "LineColor"];
                d = d[E + "LineDashStyle"];
                ...
                if (a && (l = b.getPlotLinePath({
                    ...
                    force: "pass",
                    old: c
                }))) a[c || this.isNew ? "attr" : "animate"]({d: l, opacity: n})
            }, renderMark: function (c, n, l) {
                var b = this.axis, d = b.options, a = b.chart.renderer, g = this.type, h = g ? g + "Tick" : "tick",
                    e = b.tickSize(h), m = this.mark, u = !m, E = c.x;
                c = c.y;
                ...
                var d = this.axis, a = d.horiz, g = d.options, h = this.label, e = g.labels, m = e.step;
                ...
                var b = this.axis, d = b.horiz, a = this.pos, g = v(this.tickmarkOffset, b.tickmarkOffset);
    ...
    M(J, "parts/Axis.js",
        [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
            var y = p.defined, G = p.isArray, F = p.isNumber, z = p.isString, r = p.objectEach, K = p.splat,
                v = c.addEvent, D = c.animObject, w = c.arrayMax, n = c.arrayMin, l = c.color, b = c.correctFloat,
                d = c.defaultOptions, a = c.deg2rad, g = c.destroyObjectProperties, h = c.extend, e = c.fireEvent,
                m = c.format, u = c.getMagnitude, E = c.merge, t = c.normalizeTickInterval, x = c.pick,
                k = c.removeEvent, A = c.seriesTypes, B = c.syncTimeout, H = c.Tick;
            p = function () {
            ...
            c.extend(p.prototype,
                {
                    ...
                    init: function (a, b) {
                        ...
                        b = q.options.events;
                        -1 === a.axes.indexOf(q) && (f ? a.axes.splice(a.xAxis.length,
                    ...
                    defaultLabelFormatter: function () {
                        var a = this.axis, b = this.value, e = a.chart.time, k = a.categories,
                            g = this.dateTimeLabelFormat, h = d.lang, B = h.numericSymbols;
                        h = h.numericSymbolMagnitude || 1E3;
                        var A = B && B.length, t = a.options.labels.format;
                        a = a.isLog ? Math.abs(b) : a.tickInterval;
                        if (t) var u = m(t, this, e); else if (k) u = b; else if (g) u = e.dateFormat(g, b); else if (A && 1E3 <= a) for (; A-- && void 0 === u;) e = Math.pow(h, A + 1), a >= e && 0 === 10 * b % e && null !== B[A] && 0 !== b && (u = c.numberFormat(b /
                            e, -1) + B[A]);
                    ...
                    translate: function (a,
                                         b, d, e, c, k) {
                        var f = this.linkedParent || this, q = 1, g = 0, h = e ? f.oldTransA : f.transA;
                        e = e ? f.oldMin : f.min;
                    ...
                    getPlotLinePath: function (a) {
                        var b = this, q = b.chart, d = b.left, c = b.top, k = a.old, g = a.value, h = a.translatedValue,
                            m = a.lineWidth, B = a.force, A, t, u, H, n = k && q.oldChartHeight || q.chartHeight,
                            l = k && q.oldChartWidth || q.chartWidth, E, r = b.transB, w = function (a, b, f) {
                    ...
                    getMinorTickPositions: function () {
                        var a = this, b = a.options, d = a.tickPositions, e = a.minorTickInterval, c = [],
                            k = a.pointRangePadding || 0, g = a.min - k;
                        k = a.max + k;
                        var h = k - g;
                    ...
                    adjustForMinRange: function () {
                        var a = this.options, b = this.min, d = this.max, e, c, k, g, h;
                    ...
                    getClosest: function () {
                        ...
                        this.categories ? a = 1 : this.series.forEach(function (b) {
                            var f = b.closestPointRange, d = b.visible || !b.chart.options.chart.ignoreHiddenSeries;
                            !b.noSharedTooltip && y(f) && d && (a = y(a) ? Math.min(a, f) : f)
                        });
                        return a
                    },
                    nameToX: function (a) {
                        var b = G(this.categories), d = b ? this.categories : this.names, e = a.options.x;
                    ...
                    setAxisTranslation: function (a) {
                        var b = this, d = b.max - b.min, q = b.axisPointRange || 0, c = 0, k = 0, g = b.linkedParent,
                            h = !!b.categories, m = b.transA, B = b.isXAxis;
                        if (B || h || q) {
                            var t = b.getClosest();
                    ...
                    setTickInterval: function (a) {
                        var f = this, d = f.chart, q = f.options, k = f.isLog, g = f.isDatetimeAxis, h = f.isXAxis,
                            m = f.isLinked, B = q.maxPadding, A = q.minPadding, H = q.tickInterval,
                            n = q.tickPixelInterval, l = f.categories, E = F(f.threshold) ? f.threshold : null,
                            r = f.softThreshold;
                        ...
                        if (m) {
                            ...
                            if (!r && y(E)) if (f.dataMin >= E) z = E, A = 0; else if (f.dataMax <= E) {
                                var p = E;
                                B = 0
                            }
                    ...
                    setTickPositions: function () {
                        ...
                        var k = a.tickPositioner, g = a.startOnTick, h = a.endOnTick;
                    ...
                    trimTicks: function (a, b, d) {
                        var f = a[0], q = a[a.length - 1], c = this.minPointOffset || 0;
                        e(this, "trimTicks");
                        if (!this.isLinked) {
                            if (b && -Infinity !== f) this.min = f; else for (; this.min - c > a[0];) a.shift();
                            if (d) this.max =
                                q; else for (; this.max + c < a[a.length - 1];) a.pop();
                    ...
                    adjustTickAmount: function () {
                        var a = this.options, d = this.tickInterval, e = this.tickPositions, c = this.tickAmount,
                            k = this.finalTickAmt, g = e && e.length,
                            h = x(this.threshold, this.softThreshold ? 0 : null), m;
                        if (this.hasData()) {
                            if (g < c) {
                    ...
                    zoom: function (a, b) {
                        var d = this.dataMin, f = this.dataMax, c = this.options, q = Math.min(d, x(c.min, d)),
                    ...
                    unsquish: function () {
                        var d = this.options.labels, f = this.horiz, e = this.tickInterval, c = e,
                            k = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), g, h = d.rotation,
                            m = this.labelMetrics(), B, A = Number.MAX_VALUE, t, u = this.max - this.min,
                            H = function (a) {
                                var d = a / (k || 1);
                                d = 1 < d ? Math.ceil(d) : 1;
                    ...
                    getSlotWidth: function (a) {
                        var b = this.chart, d = this.horiz, e = this.options.labels,
                            c = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), k = b.margin[3];
                    ...
                    renderUnsquish: function () {
                        var a = this.chart, b = a.renderer, d = this.tickPositions, e = this.ticks,
                            c = this.options.labels, k = c && c.style || {}, g = this.horiz, h = this.getSlotWidth(),
                            m = Math.max(1, Math.round(h - 2 * (c.padding || 5))), B = {}, A = this.labelMetrics(),
                            t = c.style && c.style.textOverflow, u = 0;
                        ...
                        if (this.autoRotation) u > m && u > A.h ? B.rotation = this.labelRotation : this.labelRotation = 0; else if (h) {
                            var H = m;
                            if (!t) {
                                var n = "clip";
                                for (m = d.length; !g && m--;) {
                                    var x = d[m];
                                    if (x = e[x].label) x.styles && "ellipsis" === x.styles.textOverflow ? x.css({textOverflow: "clip"}) : x.textPxLength > h && x.css({width: h + "px"}), x.getBBox().height > this.len / d.length - (A.h - A.f) && (x.specificTextOverflow = "ellipsis")
                                }
                            }
                        }
                        ...
                        d.forEach(function (a) {
                            var b = (a = e[a]) && a.label, d = k.width, f = {};
                            b && (b.attr(B), a.shortenLabel ? a.shortenLabel() : H && !d && "nowrap" !== k.whiteSpace && (H < b.textPxLength || "SPAN" === b.element.tagName) ? (f.width = H, t || (f.textOverflow = b.specificTextOverflow || n), b.css(f)) : b.styles && b.styles.width && !f.width && !d && b.css({width: null}), delete b.specificTextOverflow, a.rotation = B.rotation)
                        }, this);
                    ...
                    addTitle: function (a) {
                        var b = this.chart.renderer, d = this.horiz, e = this.opposite, c = this.options.title, k,
                    ...
                    getOffset: function () {
                        var a = this, b = a.chart, d = b.renderer, c = a.options, k = a.tickPositions, g = a.ticks,
                            h = a.horiz, m = a.side, B = b.inverted && !a.isZAxis ? [1, 0, 3, 2][m] : m, A, t = 0,
                            u = 0, H = c.title, n = c.labels, l = 0, E = b.axisOffset;
                        b = b.clipOffset;
                        var w = [-1, 1, 1, -1][m], z = c.className, v = a.axisParent;
                        var p = a.hasData();
                    ...
                    getLinePath: function (a) {
                        var b = this.chart, d = this.opposite, e = this.offset, c = this.horiz,
                    ...
                    getTitlePosition: function () {
                        var a = this.horiz, b = this.left, d = this.top, c = this.len, k = this.options.title,
                            g = a ? b : d, h = this.opposite, m = this.offset, B = k.x || 0, A = k.y || 0,
                            t = this.axisTitle, u = this.chart.renderer.fontMetrics(k.style && k.style.fontSize, t);
                        t = Math.max(t.getBBox(null, 0).height - u.h - 1, 0);
                        c = {low: g + (a ? 0 : c), middle: g + c / 2, high: g + (a ? c : 0)}[k.align];
                        b = (a ? d + this.height : b) + (a ? 1 : -1) * (h ? -1 : 1) * this.axisTitleMargin +
                            [-t, t, u.f, -t][this.side];
                        a = {
                    ...
                    renderTick: function (a, b) {
                        var d = this.isLinked, e = this.ticks, c = this.chart.hasRendered && F(this.oldMin);
                        if (!d || a >= this.min && a <= this.max) e[a] || (e[a] = new H(this, a)), c && e[a].isNew &&
                        e[a].render(b, !0, -1), e[a].render(b)
                    },
                    render: function () {
                        var a = this, b = a.chart, d = a.options, k = a.isLog, g = a.isLinked, h = a.tickPositions,
                            m = a.axisTitle, A = a.ticks, t = a.minorTicks, u = a.alternateBands, n = d.stackLabels,
                            x = d.alternateGridColor, l = a.tickmarkOffset, E = a.axisLine, w = a.showAxis,
                            z = D(b.renderer.globalAnimation), v, p;
                    ...
                    destroy: function (a) {
                        var b = this, d = b.stacks, c = b.plotLinesAndBands, h;
                    ...
                    drawCrosshair: function (a, b) {
                        var d, c = this.crosshair, k = x(c.snap, !0), f, g = this.cross;
                        ...
                        if (this.crosshair && !1 !== (y(b) || !k)) {
                            ...
                            g || (this.cross = g = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (k ? "category " : "thin ") + c.className).attr({zIndex: x(c.zIndex, 2)}).add(), this.chart.styledMode || (g.attr({
                                stroke: c.color ||
                                    (k ? l("#ccd6eb").setOpacity(.25).get() : "#cccccc"), "stroke-width": x(c.width, 1)
    ...
    M(J, "parts/DateTimeAxis.js", [J["parts/Globals.js"]], function (c) {
        var p = c.Axis, y = c.getMagnitude,
            G = c.normalizeTickInterval, F = c.timeUnits;
        p.prototype.getTimeTicks = function () {
            return this.chart.time.getTimeTicks.apply(this.chart.time, arguments)
        };
        p.prototype.normalizeTimeTickInterval = function (c, r) {
            var z = r || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]];
            r = z[z.length - 1];
            var v = F[r[0]], p = r[1], w;
    ...
    M(J, "parts/LogarithmicAxis.js", [J["parts/Globals.js"]], function (c) {
        var p = c.Axis, y = c.getMagnitude, G = c.normalizeTickInterval, F = c.pick;
        p.prototype.getLogTickPositions = function (c, r, p, v) {
            var z = this.options, w = this.len, n = [];
            v || (this._minorAutoInterval = null);
            if (.5 <= c) c = Math.round(c), n = this.getLinearTickPositions(c, r, p); else if (.08 <= c) {
                w = Math.floor(r);
                var l, b;
    ...
    M(J, "parts/PlotLineOrBand.js", [J["parts/Globals.js"], J["parts/Axis.js"], J["parts/Utilities.js"]], function (c, p, y) {
        var G = y.defined, F = y.erase, z = y.objectEach, r = c.arrayMax, K = c.arrayMin, v = c.destroyObjectProperties,
            D = c.merge, w = c.pick;
        ...
        c.PlotLineOrBand.prototype =
            {
                render: function () {
                    ...
                    var n = this, l = n.axis, b = l.horiz, d = n.options, a = d.label, g = n.label, h = d.to,
                        e = d.from, m = d.value, u = G(e) && G(h), E = G(m), t = n.svgElem, x = !t, k = [], A = d.color,
                        B = w(d.zIndex, 0), H = d.events;
                    k = {"class": "highcharts-plot-" + (u ? "band " : "line ") + (d.className || "")};
                    var q = {}, f = l.chart.renderer, C = u ? "bands" : "lines";
                    ...
                    }); else if (u) k = l.getPlotBandPath(e, h, d); else return;
                    (x || !t.d) && k && k.length ? (t.attr({d: k}), H && z(H, function (a, b) {
                        t.on(b, function (a) {
                            H[b].apply(n, [a])
                        })
                    })) : t && (k ? (t.show(!0),
                    ...
                    var a = this.label, g = this.axis.chart.renderer;
                    a || (a = {
        ...
        c.extend(p.prototype, {
            getPlotBandPath: function (c, l) {
                var b = this.getPlotLinePath({
                    ...
                    }), d = this.getPlotLinePath({value: c, force: !0, acrossPanes: this.options.acrossPanes}), a = [],
                    g = this.horiz, h = 1;
                ...
                var b = (new c.PlotLineOrBand(this, n)).render(), d = this.userOptions;
    ...
    M(J, "parts/Tooltip.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = p.isString, z = p.splat;
        "";
        var r = c.doc, K = c.extend, v = c.format, D = c.merge, w = c.pick, n = c.syncTimeout, l = c.timeUnits;
        c.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        c.Tooltip.prototype = {
            init: function (b, d) {
                ...
                var b = this, d = this.chart.renderer, a = this.chart.styledMode, g = this.options,
                    h = "tooltip" + (y(g.className) ? " " + g.className : ""), e;
                if (!this.label) {
                    this.outside && (this.container =
                        e = c.doc.createElement("div"), e.className = "highcharts-tooltip-container", c.css(e, {
                        position: "absolute",
                        top: "1px",
                    ...
                    if (this.outside) {
                        var m = {x: this.label.xSetter, y: this.label.ySetter};
                ...
                var a = this.chart, c = a.pointer, h = a.inverted, e = a.plotTop, m = a.plotLeft, u = 0, l = 0, t, x;
                b = z(b);
                this.followPointer && d ? (void 0 === d.chartX &&
                (d = c.normalize(d)), b = [d.chartX - a.plotLeft, d.chartY - e]) : b[0].tooltipPos ? b = b[0].tooltipPos : (b.forEach(function (a) {
                    t = a.series.yAxis;
                    x = a.series.xAxis;
                ...
                var c = this.chart, h = this.distance, e = {}, m = c.inverted && a.h || 0, u, l = this.outside,
                    ...
                    k = c.pointer.chartPosition, A = c.containerScaling, B = function (a) {
                    ...
                    }, f = q("y"), n = q("x"), N = !this.followPointer && w(a.ttBelow, !c.inverted === !!a.negative),
                    v = function (a, b, d, c, f, k, g) {
                        var q = "y" === a ? H(h) : B(h), A = (d - c) / 2, t = c < f - h, u = f + h + c < b,
                            x = f - q - d + A;
                        f = f + q - A;
                        if (N && u) e[a] = f; else if (!N && t) e[a] = x; else if (t) e[a] = Math.min(g - c, 0 > x - m ? x : x - m); else if (u) e[a] = Math.max(k, f + m + d > b ? f : f + m); else return !1
                ...
                var a = this.chart, g = this.options, h = b, e = {}, m = [];
                ...
                if (g.enabled) {
                    ...
                    }), e = {x: h[0].category, y: h[0].y}, e.points = m, h = h[0]);
                    this.len = m.length;
                    u = u.call(e, this);
                    e = h.series;
                    ...
                    !1 === u ? this.hide() : (a = this.getLabel(), this.isHidden && a.attr({opacity: 1}).show(), this.split ? this.renderSplit(u,
                        z(b)) : (g.style.width && !l || a.css({width: this.chart.spacingBox.width}), a.attr({text: u && u.join ? u.join("") : u}), a.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + w(h.colorIndex, e.colorIndex)), l || a.attr({stroke: g.borderColor || h.color || e.color || "#666666"}), this.updatePosition({
                        plotX: d,
                        plotY: x,
                        negative: h.negative,
                        ttBelow: h.ttBelow,
                ...
                var a = this, g = [], h = this.chart, e = h.renderer, m = !0, u = this.options, l = 0, t, x =
                    this.getLabel(), k = h.plotTop;
                F(b) && (b = [!1, b]);
                b.slice(0, d.length + 1).forEach(function (b, c) {
                    if (!1 !== b && "" !== b) {
                        c = d[c - 1] || {isHeader: !0, plotX: d[0].plotX, plotY: h.plotHeight};
                        var B = c.series || a, q = B.tt, f = c.series || {},
                            A = "highcharts-color-" + w(c.colorIndex, f.colorIndex, "none");
                        q || (q = {
                            padding: u.padding,
                            r: u.borderRadius
                        }, h.styledMode || (q.fill = u.backgroundColor, q["stroke-width"] = u.borderWidth), B.tt = q = e.label(null, null, null, (c.isHeader ? u.headerShape : u.shape) || "callout", null, null, u.useHTML).addClass("highcharts-tooltip-box " +
                            A).attr(q).add(x));
                        q.isActive = !0;
                        q.attr({text: b});
                ...
                var d = this.chart, a = this.getLabel(),
                ...
                var g = this.chart.time, e = g.dateFormat("%m-%d %H:%M:%S.%L", d),
                    m = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, u = "millisecond";
                for (n in l) {
                ...
                var a = d ? "footer" : "header", g = b.series, h = g.tooltipOptions, e = h.xDateFormat, m = g.xAxis,
                    u = m && "datetime" === m.options.type && G(b.key), l = h[a + "Format"];
    ...
    M(J, "parts/Pointer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = p.isObject, z = p.objectEach, r = p.splat, K = c.addEvent, v = c.attr,
            D = c.charts, w = c.color, n = c.css, l = c.extend, b = c.find, d = c.fireEvent, a = c.offset, g = c.pick,
            h = c.Tooltip;
        ...
        c.Pointer.prototype = {
            init: function (a, b) {
                ...
                var b = this.chart, d = b.options.chart, c = d.zoomType || "";
                b = b.inverted;
                ...
                d = d.yAxis;
                var e = g(a.clientX, a.plotX), h = a.shapeArgs;
                if (c && d) return b ? {
                    chartX: c.len + c.pos - e,
                    chartY: d.len + d.pos - a.plotY
                } : {chartX: e + c.pos, chartY: a.plotY + d.pos};
                ...
                var d = this.chart, e = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0,
                    h = e ? e.shared : !1, m = b || d.hoverPoint, k = m && m.series || d.hoverSeries;
                ...
                d.axes.forEach(function (b) {
                    var d = g(b.crosshair.snap, !0), e = d ? c.find(A, function (a) {
                ...
                var d = this.chart, c = d.hoverSeries, e = d.hoverPoint, g = d.hoverPoints, k = d.tooltip,
                    h = k && k.shared ? g : e;
                ...
                var b = this.chart, d = b.options.chart, c = a.chartX, e = a.chartY, g = this.zoomHor,
                    k = this.zoomVert, h = b.plotLeft, B = b.plotTop, H = b.plotWidth, q = b.plotHeight,
                    f = this.selectionMarker, l = this.mouseDownX, n = this.mouseDownY,
                ...
                if (!f || !f.touch) if (c < h ? c = h : c > h + H && (c = h + H), e < B ? e = B : e > B + q && (e = B + q), this.hasDragged = Math.sqrt(Math.pow(l - c, 2) + Math.pow(n - e, 2)), 10 < this.hasDragged) {
                    ...
                    b.hasCartesianSeries && (this.zoomX ||
                        this.zoomY) && v && !r && !f && (this.selectionMarker = f = b.renderer.rect(h, B, g ? 1 : H, k ? 1 : q, 0).attr({
                        "class": "highcharts-selection-marker",
                        zIndex: 7
                    }).add(), b.styledMode || f.attr({fill: d.selectionMarkerFill || w("#335cad").setOpacity(.25).get()}));
                ...
                if (this.selectionMarker) {
                    var g = {originalEvent: a, xAxis: [], yAxis: []},
                        h = this.selectionMarker, k = h.attr ? h.attr("x") : h.x, A = h.attr ? h.attr("y") : h.y,
                        B = h.attr ? h.attr("width") : h.width, H = h.attr ? h.attr("height") : h.height, q;
                    if (this.hasDragged || e) c.axes.forEach(function (d) {
                        if (d.zoomEnabled && y(d.min) && (e || b[{xAxis: "zoomX", yAxis: "zoomY"}[d.coll]])) {
                ...
                var b = this.chart, c = b.hoverPoint, e = b.plotLeft, g = b.plotTop;
                a = this.normalize(a);
    ...
    M(J, "parts/TouchPointer.js", [J["parts/Globals.js"]], function (c) {
        var p = c.charts, y = c.extend, G = c.noop, F = c.pick;
        y(c.Pointer.prototype,
            {
                pinchTranslate: function (c, r, p, v, y, w) {
                    ...
                    var b = this.chart, d = c ? "x" : "y", a = c ? "X" : "Y", g = "chart" + a,
                        h = c ? "width" : "height", e = b["plot" + (c ? "Left" : "Top")], m, u, E = l || 1,
                        t = b.inverted, x = b.bounds[c ? "h" : "v"], k = 1 === r.length, A = r[0][g], B = p[0][g],
                        H = !k && r[1][g], q = !k && p[1][g];
                    p = function () {
                    ...
                    var r = this, p = r.chart, v = r.pinchDown, z = c.touches, w = z.length, n = r.lastValidTouch,
                        l = r.hasZoom, b = r.selectionMarker, d = {},
                    ...
                    "touchstart" === c.type ? ([].forEach.call(z, function (a, b) {
                        ...
                        if (a.zoomEnabled) {
                            var b = p.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding,
                                ...
                                g = a.toPixels(Math.max(F(a.options.max, a.dataMax), a.dataMax)), h = Math.max(c,
                                g);
                    ...
                    if (1 === p.touches.length) if (p = this.normalize(p),
                    (v = z.isInsidePlot(p.chartX - z.plotLeft, p.chartY - z.plotTop)) && !z.openMenu) {
                        ...
                        F(y, !0) && this.pinch(p)
                    } else r && this.reset(); else 2 === p.touches.length && this.pinch(p)
    ...
    M(J, "parts/MSPointer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.objectEach, G = c.addEvent, F = c.charts, z = c.css, r = c.doc;
        p = c.extend;
        var K = c.noop, v = c.Pointer, D = c.removeEvent, w = c.win, n = c.wrap;
        if (!c.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var l = {}, b = !!w.PointerEvent, d = function () {
                var a = [];
                a.item = function (a) {
                    return this[a]
                };
                ...
                !F[c.hoverChartIndex] || (m(a), m = F[c.hoverChartIndex].pointer, m[b]({
                    type: e,
    ...
    M(J, "parts/Legend.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = c.addEvent, z = c.css, r = c.discardElement, K = c.fireEvent;
        p = c.isFirefox;
        var v = c.marginNames, D = c.merge, w = c.pick, n = c.setAnimation, l = c.stableSort, b = c.win, d = c.wrap;
        ...
        c.Legend.prototype = {
            init: function (a, b) {
                ...
                if (!this.chart.styledMode) {
                    var d = this.options, c = a.legendItem, g = a.legendLine, l = a.legendSymbol,
                        n = this.itemHiddenStyle.color;
                    d = b ? d.itemStyle.color : n;
                    var t = b ? a.color || n : n, x = a.options && a.options.marker, k = {fill: t};
                ...
                var b = this.options, d = b.symbolPadding;
                b = !b.rtl;
                var c = a._legendItemPos, m = c[0];
                c = c[1];
                var l = a.checkbox;
                ...
                var a = this.options, b = this.padding, d = a.title, c = 0;
                ...
                var b = this.chart,
                    ...
                    t = this.itemHiddenStyle, x = "horizontal" === c.layout ? w(c.itemDistance, 20) : 0, k = !c.rtl,
                    A = a.legendItem, B = !a.series, H = !B && a.series.drawLegendSymbol ? a.series : a, q = H.options;
                q = this.createCheckboxForItem && q && q.showCheckbox;
                x = m + l + x + (q ? 20 : 0);
                var f = c.useHTML, C = a.options.className;
                A || (a.legendGroup = d.g("legend-item").addClass("highcharts-" + H.type + "-series highcharts-color-" + a.colorIndex + (C ? " " + C : "") + (B ? " highcharts-series-" + a.index :
                    "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = A = d.text("", k ? m + l : -l, this.baseline || 0, f), b.styledMode || A.css(D(a.visible ? n : t)), A.attr({
                    align: k ? "left" : "right",
                    zIndex: 2
                ...
                var b = this.options, d = this.padding, c = "horizontal" === b.layout, m = a.itemHeight,
                    l = b.itemMarginBottom || 0, n = this.itemMarginTop, t = c ? w(b.itemDistance, 20) : 0,
                ...
                var d =
                        this.chart, c = this.options, g = this.getAlignment(), l = d.options.title.margin,
                    n = void 0 !== l ? d.titleOffset[0] + l : 0, t = void 0 !== l ? d.titleOffset[2] + l : 0;
                ...
                var a =
                    this.chart, b = a.renderer, d = this.group, e, m = this.box, n = this.options, w = this.padding;
                this.itemX = w;
                this.itemY = this.initialItemY;
                this.lastItemY = this.offsetWidth = 0;
                this.widthOption = c.relativeLength(n.width, a.spacingBox.width - w);
                var t = a.spacingBox.width - 2 * w - n.x;
                ...
                e && (b = a.options.title.margin, m = a.spacingBox, w = m.y, /(lth|ct|rth)/.test(this.getAlignment()) && 0 < a.titleOffset[0] ? w += a.titleOffset[0] + b : /(lbh|cb|rbh)/.test(this.getAlignment()) &&
                    0 < a.titleOffset[2] && (w -= a.titleOffset[2] + b), w !== m.y && (m = D(m, {y: w})), d.align(D(n, {
                    width: t,
                    height: x,
                ...
                var b = this, d = this.chart, c = d.renderer, m = this.options, l = m.y, n = this.padding;
                l = d.spacingBox.height + ("top" === m.verticalAlign ? -l : l) - n;
                var t = m.maxHeight, x, k = this.clipRect, A = m.navigation, B = w(A.animation, !0),
                    H = A.arrowSize || 12, q = this.nav, f = this.pages, C, r = this.allItems,
                    p = function (a) {
                ...
                a > l && !1 !== A.enabled ? (this.clipHeight = x = Math.max(l - 20 - this.titleHeight -
                    n, 0), this.currentPage = w(this.currentPage, 1), this.fullHeight = a, r.forEach(function (a, b) {
                    var d = a._legendItemPos[1], c = Math.round(a.legendItem.getBBox().height), k = f.length;
                    if (!k || d - f[k - 1] > x && (C || d) !== f[k - 1]) f.push(C || d), k++;
                    a.pageIx = k - 1;
                    C && (r[b - 1].pageIx = k - 1);
                    b === r.length - 1 && d + c - f[k - 1] > x && d !== C && (f.push(d), a.pageIx = k);
                    d !== C && (C = d)
                }), k || (k = b.clipRect = c.clipRect(0, n, 9999, 0), b.contentGroup.clip(k)), p(x), q || (this.nav = q = c.g().attr({zIndex: 1}).add(this.group), this.up = c.symbol("triangle", 0, 0, H, H).add(q), v("upTracker").on("click",
                    function () {
                        b.scroll(-1, B)
                    ...
                    b.scroll(1, B)
                })), b.scroll(0), a = l) : q && (p(), this.nav = q.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            }, scroll: function (a, b) {
                var d = this.pages, c = d.length, g = this.currentPage + a;
                a = this.clipHeight;
                var l = this.options.navigation, w = this.pager,
                    t = this.padding;
                g > c && (g = c);
                ...
                }), w.attr({text: g + "/" + c}), [this.down, this.downTracker].forEach(function (a) {
                    a.attr({
                        x: 18 + this.pager.getBBox().width,
                        "class": g === c ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"
                    })
                }, this), this.chart.styledMode ||
        ...
        c.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                ...
                var b = this.options, d = b.marker, c = a.symbolWidth, m = a.symbolHeight, l = m / 2,
                    n = this.chart.renderer, t = this.legendGroup;
    ...
    M(J, "parts/Chart.js", [J["parts/Globals.js"], J["parts/Utilities.js"]],
        function (c, p) {
            var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isObject, K = p.isString,
                v = p.objectEach, D = p.pInt, w = p.splat, n = c.addEvent, l = c.animate, b = c.animObject, d = c.attr,
                a = c.doc, g = c.Axis, h = c.createElement, e = c.defaultOptions, m = c.discardElement, u = c.charts,
                E = c.css, t = c.extend, x = c.find, k = c.fireEvent, A = c.Legend, B = c.marginNames, H = c.merge,
                q = c.Pointer, f = c.pick, C = c.removeEvent, N = c.seriesTypes, T = c.syncTimeout, R = c.win,
                S = c.Chart = function () {
            ...
            t(S.prototype, {
                callbacks: [], getArgs: function () {
                    ...
                    var d, f = a.series, g = a.plotOptions || {};
                    ...
                    k(this, "beforeRedraw");
                    var b = this.axes, d = this.series, f = this.pointer, e = this.legend, g = this.userOptions.legend,
                        h = this.isDirtyLegend, q = this.hasCartesianSeries,
                        B = this.isDirtyBox, A = this.renderer, m = A.isHidden(), l = [];
                    ...
                    var a = this, b = this.options, d = b.xAxis = w(b.xAxis || {});
                    b = b.yAxis = w(b.yAxis || {});
                    k(this, "getAxes");
                    ...
                    var c = this, f = c.options, k = c.styledMode;
                    var e = f.title = H(!k && {
                        style: {
                            color: "#333333",
                    ...
                    [["title", a, e], ["subtitle", b, f]].forEach(function (a, b) {
                        var d = a[0], f = c[d], e = a[1];
                        a = a[2];
                        f && e && (c[d] = f = f.destroy());
                    ...
                    ["title", "subtitle"].forEach(function (a) {
                        var f =
                            this[a], k = this.options[a], e = "title" === a ? -3 : k.verticalAlign ? 0 : b[0] + 2;
                        a = "subtitle" === a && "bottom" === k.verticalAlign;
                        if (f) {
                            if (!this.styledMode) var g = k.style.fontSize;
                            g = d.fontMetrics(g, f).b;
                            f.css({width: (k.width || c.width + k.widthAdjust) + "px"});
                    ...
                    if (b) for (; d && d.style;) d.hcOrigStyle && (c.css(d, d.hcOrigStyle), delete d.hcOrigStyle), d.hcOrigDetached && (a.body.removeChild(d), d.hcOrigDetached = !1), d = d.parentNode; else for (; d && d.style;) {
                        ...
                        if ("none" === c.getStyle(d, "display", !1) || d.hcOricDetached) d.hcOrigStyle = {
                            ...
                            display: "block",
                            overflow: "hidden"
                        }, d !== this.renderTo && (b.height = 0), c.css(d, b), d.offsetWidth ||
                    ...
                    var b = this.options, f = b.chart;
                    var e = this.renderTo;
                    var g = c.uniqueKey(), q, B;
                    ...
                    if (this.styledMode) for (B in b.defs) this.renderer.definition(b.defs[B]); else this.renderer.setStyle(f.style);
                    ...
                    var d = this, f = d.options.chart, k = d.renderTo, e = y(f.width) && y(f.height),
                        g = f.width || c.getStyle(k, "width");
                    f = f.height || c.getStyle(k, "height");
                    k = b ? b.target : R;
                    if (!e &&
                        !d.isPrinting && g && f && (k === R || k === a)) {
                    ...
                    if (!e.styledMode) {
                        ...
                        (h ? l : E)(e.container, {width: e.chartWidth + "px", height: e.chartHeight + "px"}, h)
                    }
                    e.setChartSize(!0);
                    ...
                    var b = this.inverted, d = this.renderer, c = this.chartWidth, f = this.chartHeight,
                        e = this.options.chart, g = this.spacing, h = this.clipOffset, q, B, A, m;
                    ...
                    var a = this.options.chart, b = this.renderer, d = this.chartWidth, c = this.chartHeight,
                        ...
                        e = this.plotBackground, g = this.plotBorder, h = this.styledMode, q = this.plotBGImage,
                        B = a.backgroundColor, A = a.plotBackgroundColor, m = a.plotBackgroundImage, l,
                        t = this.plotLeft, n = this.plotTop, H = this.plotWidth, x = this.plotHeight, C = this.plotBox,
                        u = this.clipRect, w = this.clipBox, r = "animate";
                    f || (this.chartBackground = f = b.rect().addClass("highcharts-background").add(), r = "attr");
                    if (h) var p = l = f.strokeWidth(); else {
                        p = a.borderWidth || 0;
                        l = p + (a.shadow ? 8 : 0);
                        B = {fill: B || "none"};
                    ...
                    var a = this, b = a.options.chart, d, c = a.options.series, f, k;
                    ...
                    b.items && b.items.forEach(function (d) {
                        var c = t(b.style, d.style),
                            f = D(c.left) + a.plotLeft, k = D(c.top) + a.plotTop + 12;
                        delete c.left;
                        delete c.top;
                        a.renderer.text(d.html, f, k).attr({zIndex: 2}).css(c).add()
                    })
                }, render: function () {
                    var a = this.axes, b = this.renderer, d = this.options, c = 0;
                    this.setTitle();
                    ...
                    var a = this, b = a.axes, d = a.series, f = a.container, e, g = f && f.parentNode;
                    k(a, "destroy");
    ...
    M(J, "parts/ScrollablePlotArea.js", [J["parts/Globals.js"]],
        function (c) {
            var p = c.addEvent, y = c.Chart;
            "";
            p(y, "afterSetChartSize", function (p) {
                var y = this.options.chart.scrollablePlotArea, z = y && y.minWidth;
                y = y && y.minHeight;
                if (!this.renderer.forExport) {
                    if (z) {
                        if (this.scrollablePixelsX = z = Math.max(0, z - this.chartWidth)) {
                            ...
                            var r = {1: {name: "right", value: z}}
                        }
                    } else y && (this.scrollablePixelsY = z = Math.max(0, y - this.chartHeight)) && (this.plotHeight += z, this.inverted ?
                        (this.clipBox.width += z, this.plotBox.width += z) : (this.clipBox.height += z, this.plotBox.height += z), r = {
                        2: {
                            name: "bottom",
                            value: z
                        }
            ...
            y.prototype.moveFixedElements = function () {
                var c = this.container, p = this.fixedRenderer,
            ...
            y.prototype.applyFixed = function () {
                var y, F = !this.fixedDiv, z = this.options.chart.scrollablePlotArea;
                F ? (this.fixedDiv = c.createElement("div", {className: "highcharts-fixed"}, {
                    position: "absolute",
                    overflow: "hidden",
                    pointerEvents: "none",
                    zIndex: 2
                }, null, !0), this.renderTo.insertBefore(this.fixedDiv,
                    this.renderTo.firstChild), this.renderTo.style.overflow = "visible", this.fixedRenderer = y = new c.Renderer(this.fixedDiv, this.chartWidth, this.chartHeight), this.scrollableMask = y.path().attr({
                ...
                1, "L", r, this.plotTop - 1, "L", r, 0, "Z", "M", z, v, "L", z, this.chartHeight, "L", r, this.chartHeight, "L", r, v, "Z"] : ["M", 0, 0];
    ...
    M(J, "parts/Point.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isObject, K, v = c.extend, D = c.fireEvent,
        ...
        c.Point.prototype = {
            init: function (b, a, c) {
                ...
                var a = {}, d = this.series, h = d.options.keys, e = h || d.pointArrayMap || ["y"], m = e.length, l = 0,
                    n = 0;
                if (z(b) || null === b) a[e[0]] = b; else if (F(b)) for (!h && b.length > m && (d = typeof b[0], "string" === d ? a.name = b[0] : "number" === d && (a.x = b[0]), l++); n < m;) h && void 0 === b[l] || (0 < e[n].indexOf(".") ? c.Point.prototype.setNestedProperty(a,
                    b[l], e[n]) : a[e[n]] = b[l]), l++, n++; else "object" === typeof b && (a = b, b.dataLabels && (d._hasPointLabels = !0), b.marker && (d._hasPointMarkers = !0));
                return a
                ...
                var d = this.series.chart, a = d.hoverPoints, c;
                d.pointCount--;
                ...
                var a = this.series, d = a.tooltipOptions, c = n(d.valueDecimals, ""), e = d.valuePrefix || "",
                    m = d.valueSuffix || "";
    ...
    M(J, "parts/Series.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isString,
            K = p.objectEach, v = p.splat, D = c.addEvent, w = c.animObject, n = c.arrayMax, l = c.arrayMin,
            b = c.correctFloat, d = c.defaultOptions, a = c.defaultPlotOptions, g = c.extend, h = c.fireEvent,
            e = c.merge, m = c.pick, u = c.removeEvent, E = c.SVGElement, t = c.syncTimeout, x = c.win;
        c.Series = c.seriesType("line", null, {
            ...
            updateParallelArrays: function (a, b) {
                var d = a.series, c = arguments, e = z(b) ? function (c) {
            ...
            autoIncrement: function () {
                var a =
                    this.options, b = this.xIncrement, d, c = a.pointIntervalUnit, e = this.chart.time;
            ...
            setOptions: function (a) {
                var b = this.chart, c = b.options, k = c.plotOptions, g = b.userOptions || {};
                a = e(a);
                b = b.styledMode;
                var f = {plotOptions: k, userOptions: a};
                h(this, "setOptions", f);
                var l = f.plotOptions[this.type], n = g.plotOptions || {};
            ...
            getCyclic: function (a, b, d) {
                var c = this.chart, e = this.userOptions, f = a + "Index", k = a + "Counter",
            ...
            findPointIndex: function (a, b) {
                ...
                void 0 === f && z(a) && (f = this.xData.indexOf(a, b));
            ...
            updateData: function (a) {
                var b = this.options, d = this.points,
                    c = [], e, f, k, g = this.requireSorting, h = a.length === d.length, m = !0;
                this.xIncrement = null;
                a.forEach(function (a, f) {
                    var q = y(a) && this.pointClass.prototype.optionsToObject.call({series: this}, a) || {};
                    var m = q.x;
                ...
                if (e) for (a = d.length; a--;) (f = d[a]) && !f.touched && f.remove(!1); else h ? a.forEach(function (a, b) {
                    d[b].update &&
            ...
            setData: function (a, b, d, e) {
                var k = this, f = k.points, g = f && f.length || 0, h, A = k.options, l = k.chart, B = null,
                    n = k.xAxis, t = A.turboThreshold, H = this.xData, x = this.yData,
                    u = (h = k.pointArrayMap) && h.length, w = A.keys, p = 0, v = 1, E;
                a = a || [];
                h = a.length;
                b = m(b, !0);
                ...
                if (!E) {
                    ...
                    if (t && h > t) {
                        ...
                        if (z(B)) for (d = 0; d < h; d++) H[d] = this.autoIncrement(), x[d] = a[d]; else if (F(B)) if (u) for (d = 0; d < h; d++) B = a[d], H[d] = B[0], x[d] = B.slice(1, u + 1); else for (w && (p = w.indexOf("x"), v = w.indexOf("y"), p = 0 <= p ? p : 0, v = 0 <= v ? v : 1), d = 0; d < h; d++) B = a[d], H[d] = B[p], x[d] = B[v]; else c.error(12, !1, l)
                    } else for (d = 0; d < h; d++) void 0 !== a[d] && (B = {series: k}, k.pointClass.prototype.applyOptions.apply(B,
                        [a[d]]), k.updateParallelArrays(B, d));
            ...
            processData: function (a) {
                ...
                if (l && this.sorted && !m && (!h || e > h || this.forceCrop)) if (b[e - 1] < x || b[0] > u) b = [], d = []; else if (this.yData && (b[0] < x || b[e - 1] > u)) {
                ...
                for (h = b.length || 1; --h;) if (e = n ? g(b[h]) - g(b[h - 1]) : b[h] - b[h - 1], 0 < e && (void 0 === p || e < p)) var p = e; else 0 > e && t && (c.error(15,
                    !1, this.chart), t = !1);
                this.cropped = w;
                this.cropStart = k;
            ...
            generatePoints: function () {
                var a = this.options, b = a.data, d = this.data, c, e = this.processedXData, f = this.processedYData,
                    m = this.pointClass,
                    l = e.length, n = this.cropStart || 0, t = this.hasGroupedData;
                a = a.keys;
                var x = [], u;
            ...
            getXExtremes: function (a) {
                return {min: l(a), max: n(a)}
            },
            getExtremes: function (a) {
                var b = this.yAxis, d = this.processedXData, c = [], e = 0;
                var f = this.xAxis.getExtremes();
                var k = f.min, g = f.max, m = this.requireSorting ? this.cropShoulder : 0, t;
                ...
                for (t = 0; t < f; t++) {
                    ...
                    if (p && x) if (p = u.length) for (; p--;) z(u[p]) && (c[e++] = u[p]); else c[e++] = u
                }
                this.dataMin = l(c);
                this.dataMax = n(c);
            ...
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, d = a.stacking, c = this.xAxis, e = c.categories, g = this.yAxis, f = this.points,
                    l = f.length, t = !!this.modifyValue, n, x = this.pointPlacementToXValue(), u = z(x),
                    p = a.threshold, w = a.startFromThreshold ?
                    p : 0, r, v = this.zoneAxis || "y", E = Number.MAX_VALUE;
                for (n = 0; n < l; n++) {
                    var D = f[n], K = D.x;
                    var G = D.y;
                    var J = D.low, M = d && g.stacks[(this.negStacks && G < (w ? 0 : p) ? "-" : "") + this.stackKey];
                    ...
                    F(Y) && (J = Y[0], G = Y[1], J === w && X.key === M[K].base && (J = m(z(p) && p, g.min)), g.positiveValuesOnly &&
            ...
            getClipBox: function (a, b) {
                var d = this.options, c = this.chart, e = c.inverted, f = this.xAxis, k = f && this.yAxis;
                a && !1 === d.clip && k ? a = e ? {
                    y: -c.chartWidth + k.len + k.pos, height: c.chartWidth,
                    width: c.chartHeight, x: -c.chartHeight + f.len + f.pos
                } : {
                    y: -k.pos,
            ...
            setClip: function (a) {
                var b = this.chart, d = this.options, c = b.renderer, e = b.inverted, f = this.clipBox,
                    k = this.getClipBox(a),
            ...
            markerAttribs: function (a, b) {
                var d = this.options.marker, c = a.marker || {}, e = c.symbol || d.symbol, f = m(c.radius, d.radius);
            ...
            pointAttribs: function (a, b) {
                var d = this.options.marker, c = a && a.options, e = c &&
                    c.marker || {}, f = this.color, k = c && c.color, g = a && a.color;
            ...
            destroy: function (a) {
                var b = this, d = b.chart, e = /AppleWebKit\/533/.test(x.navigator.userAgent),
                    k, f, g = b.data || [], m, l;
                h(b, "destroy");
                a || u(b);
            ...
            getGraphPath: function (a, b, d) {
                ...
                a.forEach(function (k, q) {
                    ...
                    k.isNull && !y(b) && 0 < q ? m = !e.connectNulls : k.isNull && !b ? m = !0 : (0 === q || m ? q = ["M", k.plotX, k.plotY] : c.getPointSpline ? q = c.getPointSpline(a, k, q) : f ? (q = 1 === f ? ["L", n.plotX, t] : 2 === f ? ["L", (n.plotX + l) / 2, n.plotY,
                        "L", (n.plotX + l) / 2, t] : ["L", l, n.plotY], q.push("L", l, t)) : q = ["L", l, t], h.push(k.x), f && (h.push(k.x), 2 === f && h.push(k.x)), g.push.apply(g, q), m = !1)
                });
                g.xMap = h;
            ...
            drawGraph: function () {
                ...
                e.forEach(function (e, k) {
                    var f = e[0], g = a[f], h = g ? "animate" : "attr";
            ...
            applyZones: function () {
                var a = this, b = this.chart, d = b.renderer, c = this.zones, e, f, g = this.clips || [], h,
                    l = this.graph, t = this.area, n = Math.max(b.chartWidth, b.chartHeight),
                    x = this[(this.zoneAxis || "y") + "Axis"], u = b.inverted, p, w, r, v = !1;
            ...
            plotGroup: function (a, b, d, c, e) {
                ...
                f.attr({visibility: d})[k ? "attr" : "animate"](this.getPlotBox());
                return f
            },
            getPlotBox: function () {
                var a = this.chart,
            ...
            render: function () {
                var a = this, b = a.chart, d = a.options,
                    ...
                    e = a.visible ? "inherit" : "hidden", f = d.zIndex, g = a.hasRendered, m = b.seriesGroup,
                    l = b.inverted;
                h(this, "render");
            ...
            redraw: function () {
                var a = this.chart, b = this.isDirty || this.isDirtyData, d = this.group, c = this.xAxis, e =
                    this.yAxis;
                d && (a.inverted && d.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), d.animate({translateX: m(c && c.left, a.plotLeft), translateY: m(e && e.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchKDTree: function (a, b, d) {
                function c(a, b, d, h) {
                    var m = b.point, l = e.kdAxisArray[d % h], q = m;
                ...
                var e = this, f = this.kdAxisArray[0], g = this.kdAxisArray[1], k = b ? "distX" : "dist";
    ...
    M(J, "parts/Stacking.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.objectEach;
        p = c.Axis;
        var F = c.Chart, z = c.correctFloat, r = c.destroyObjectProperties, K = c.format, v = c.pick, D = c.Series;
        ...
        c.StackItem.prototype = {
            destroy: function () {
                ...
                var n = this.axis.chart, l = this.options, b = l.format;
                ...
                if (n && d) {
                    var g = n.getBBox(), h = a.inverted ? c ? g.width : 0 : g.width / 2,
                ...
                var h = n.axis.reversed, e = c.inverted;
        ...
        p.prototype.buildStacks = function () {
            var c = this.series, n = v(this.options.reversedStacks, !0), l = c.length, b;
            if (!this.isXAxis) {
        ...
        p.prototype.renderStackTotals = function () {
            var c = this.chart, n = c.renderer, l = this.stacks,
        ...
        D.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var p = this.processedXData, n = this.processedYData, l = [], b = n.length, d = this.options,
                    a = d.threshold, g = v(d.startFromThreshold && a, 0), h = d.stack;
                d = d.stacking;
                var e = this.stackKey, m = "-" + e, u = this.negStacks, r = this.yAxis, t = r.stacks, x = r.oldStacks,
                    k, A;
                r.stacksTouched += 1;
                for (A = 0; A < b; A++) {
                    var B = p[A];
        ...
        D.prototype.modifyStacks = function () {
            var c = this, n = c.stackKey, l = c.yAxis.stacks, b = c.processedXData, d, a = c.options.stacking;
            c[a + "Stacker"] && [n, "-" + n].forEach(function (g) {
                for (var h = b.length, e, m; h--;) if (e = b[h], d = c.getStackIndicator(d,
        ...
        D.prototype.getStackIndicator = function (c, n, l, b) {
            !y(c) || c.x !== n || b && c.key !== b ? c = {x: n, index: 0, key: b} : c.index++;
    ...
    M(J, "parts/Dynamics.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isObject, K = p.isString,
            v = p.objectEach, D = p.splat, w = c.addEvent, n = c.animate, l = c.Axis;
        p = c.Chart;
        var b = c.createElement, d = c.css, a = c.extend, g = c.fireEvent, h = c.merge, e = c.pick, m = c.Point,
            u = c.Series, E = c.seriesTypes, t = c.setAnimation;
        c.cleanRecursively = function (a, b) {
            var d = {};
            v(a, function (e, g) {
                if (r(a[g], !0) && !a.nodeType && b[g]) e = c.cleanRecursively(a[g], b[g]), Object.keys(e).length && (d[g] = e); else if (r(a[g]) || a[g] !== b[g]) d[g] = a[g]
            });
            return d
        };
        a(p.prototype, {
            ...
            showLoading: function (c) {
                var g = this, h = g.options, m = g.loadingDiv, l = h.loading, q = function () {
                    m && d(m, {
                        left: g.plotLeft + "px",
                        top: g.plotTop + "px",
                ...
                g.styledMode || (d(m, a(l.style, {zIndex: 10})), d(g.loadingSpan, l.labelStyle), g.loadingShown || (d(m, {
                    opacity: 0,
                    display: ""
                }), n(m, {opacity: l.style.opacity || .5}, {duration: l.showDuration || 0})));
                g.loadingShown = !0;
                q()
            },
            hideLoading: function () {
                var a = this.options,
                    b = this.loadingDiv;
                b && (b.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || n(b, {opacity: 0}, {
            ...
            update: function (a, b, d, m) {
                var k = this, l = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, f, n, t,
                    x = a.isResponsiveOptions, A = [];
                ...
                if (f = a.chart) {
                    ...
                    "alignTicks" in f && (u = !0);
                    v(f, function (a, b) {
                        -1 !== k.propsRequireUpdateSeries.indexOf("chart." + b) && (n = !0);
                ...
                v(a, function (a, b) {
                    if (k[b] && "function" === typeof k[b].update) k[b].update(a, !1); else if ("function" === typeof k[l[b]]) k[l[b]](a);
        ...
        a(m.prototype, {
            update: function (a, b, d, c) {
                ...
                var k = this, f = k.series, h = k.graphic, m, l = f.chart, n = f.options;
                b = e(b, !0);
        ...
        a(u.prototype, {
            addPoint: function (a, b, d, c, h) {
                var k = this.options, f = this.data, m = this.chart, l = this.xAxis;
                l = l && l.hasNames && l.names;
                var n = k.data, t = this.xData, x;
                b = e(b, !0);
                var u = {series: this};
                ...
                var c = this, g = c.data, k = g[a], f = c.points, h = c.chart, m = function () {
                ...
                var k = this, m = k.chart, l = k.userOptions, n = k.initialType || k.type,
                    f = b.type || l.type || m.options.chart.type, t = !(this.hasDerivedData ||
                    b.dataGrouping || f && f !== this.type || void 0 !== b.pointStart || b.pointInterval || b.pointIntervalUnit || b.keys),
                    u = E[n].prototype, x, p = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"],
                    r = ["eventOptions", "navigatorSeries", "baseSeries"], v = k.finishedAnimating && {animation: !1},
                    w = {};
    ...
    M(J, "parts/AreaSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.objectEach, G = c.color, F = c.pick, z = c.Series;
        p = c.seriesType;
        p("area", "line",
            {softThreshold: !1, threshold: 0}, {
                singleStacks: !1, getStackPoints: function (c) {
                    var p = [], r = [], z = this.xAxis, w = this.yAxis, n = w.stacks[this.stackKey], l = {},
                        b = this.index, d = w.series, a = d.length, g = F(w.options.reversedStacks, !0) ? 1 : -1, h;
                    c = c || this.points;
                    if (this.options.stacking) {
                        ...
                        r.forEach(function (d, c) {
                            var m = 0, t, u;
                            if (l[d] &&
                                !l[d].isNull) p.push(l[d]), [-1, 1].forEach(function (k) {
                                var m = 1 === k ? "rightNull" : "leftNull", p = 0, x = n[r[c + k]];
                    ...
                    var r = z.prototype.getGraphPath, v = this.options, y = v.stacking,
                        w = this.yAxis, n, l = [], b = [], d = this.index, a = w.stacks[this.stackKey], g = v.threshold,
                    ...
                    var e = function (c, e, k) {
                        ...
                        void 0 !== t && (b.push({
                            ...
                            isNull: m,
                            isCliff: !0
                        }), l.push({plotX: u, plotY: null === q ? h : w.getThreshold(q), doCurve: !1}))
                    };
                    p = p || this.points;
                    ...
                    var c = this, p = this.areaPath, v = this.options,
                        y = [["area", "highcharts-area", this.color, v.fillColor]];
                    ...
                    y.forEach(function (r) {
                        var n = r[0], l = c[n], b = l ? "animate" : "attr", d = {};
    ...
    M(J, "parts/SplineSeries.js", [J["parts/Globals.js"]], function (c) {
        ...
        c("spline", "line", {}, {
            getPointSpline: function (c, G, F) {
                var y = G.plotX, r = G.plotY, K = c[F - 1];
                F = c[F + 1];
    ...
    M(J, "parts/AreaSplineSeries.js", [J["parts/Globals.js"]], function (c) {
        var p = c.seriesTypes.area.prototype, y = c.seriesType;
    ...
    M(J, "parts/ColumnSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = c.animObject, z = c.color, r = c.extend, K = c.merge, v = c.pick,
            D = c.Series;
        p = c.seriesType;
        var w = c.svg;
        p("column", "line", {
            ...
            getColumnMetrics: function () {
                var c =
                    this, l = c.options, b = c.xAxis, d = c.yAxis, a = b.options.reversedStacks;
                a = b.reversed && !a || !b.reversed && a;
                var g, h = {}, e = 0;
                !1 === l.grouping ? e = 1 : c.chart.series.forEach(function (a) {
                    var b = a.yAxis, k = a.options;
                ...
                var m = Math.min(Math.abs(b.transA) * (b.ordinalSlope || l.pointRange || b.closestPointRange || b.tickInterval ||
                    1), b.len), u = m * l.groupPadding, p = (m - 2 * u) / (e || 1);
            ...
            crispCol: function (c, l, b, d) {
                var a = this.chart, g = this.borderWidth, h = -(g % 2 ? .5 : 0);
                g = g % 2 ? .5 : 1;
            ...
            translate: function () {
                var c = this, l = c.chart, b = c.options, d = c.dense = 2 > c.closestPointRange * c.xAxis.transA;
                d = c.borderWidth = v(b.borderWidth, d ? 0 : 1);
                var a = c.yAxis, g = b.threshold, h = c.translatedThreshold = a.getThreshold(g),
                    e = v(b.minPointLength, 5), m = c.getColumnMetrics(), p = m.width,
                    r = c.barW = Math.max(p, 1 + 2 * d), t = c.pointXOffset = m.offset, x = c.dataMin, k = c.dataMax;
                l.inverted && (h -= .5);
                b.pointPadding && (r = Math.ceil(r));
                D.prototype.translate.apply(c);
                c.points.forEach(function (b) {
                    var d =
                        v(b.yBottom, h), m = 999 + Math.abs(d), n = p;
                    m = Math.min(Math.max(-m, b.plotY), a.len + m);
                    var f = b.plotX + t, u = r, A = Math.min(m, d), w = Math.max(m, d) - A;
                    if (e && Math.abs(w) < e) {
                        w = e;
            ...
            pointAttribs: function (c, l) {
                var b = this.options, d = this.pointAttrToOptions || {};
                var a = d.stroke || "borderColor";
                var g = d["stroke-width"] || "borderWidth", h = c && c.color || this.color,
                    e = c && c[a] || b[a] || this.color || h, m = c && c[g] || b[g] || this[g] || 0;
                d = c &&
            ...
            drawPoints: function () {
                var c =
                    this, l = this.chart, b = c.options, d = l.renderer, a = b.animationLimit || 250, g;
                c.points.forEach(function (h) {
                    var e = h.graphic, m = e && l.pointCount < a ? "animate" : "attr";
                    if (G(h.plotY) && null !== h.y) {
                        g = h.shapeArgs;
                        e && e.element.nodeName !== h.shapeType && (e = e.destroy());
                        if (e) e[m](K(g)); else h.graphic = e = d[h.shapeType](g).add(h.group || c.group);
            ...
            animate: function (c) {
                var l = this, b = this.yAxis, d = l.options, a = this.chart.inverted, g = {},
                    h = a ? "translateX" : "translateY";
                if (w) if (c) g.scaleY = .001, c = Math.min(b.pos + b.len, Math.max(b.pos, b.toPixels(d.threshold))), a ? g.translateX = c - b.len : g.translateY = c, l.clipBox && l.setClip(), l.group.attr(g); else {
                    var e = l.group.attr(h);
                    l.group.animate({scaleY: 1}, r(F(l.options.animation), {
                        step: function (a, d) {
                            g[h] = e + d.pos * (b.pos - e);
                            l.group.attr(g)
                        }
    ...
    M(J, "parts/ScatterSeries.js", [J["parts/Globals.js"]], function (c) {
        ...
        y("scatter", "line", {
            ...
            applyJitter: function () {
                var c = this, p = this.options.jitter, y = this.points.length;
    ...
    M(J, "mixins/centered-series.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.isNumber, G = c.deg2rad, F = c.pick, z = c.relativeLength;
        c.CenteredSeriesMixin = {
            getCenter: function () {
                var c = this.options, p = this.chart, v = 2 * (c.slicedOffset || 0), y = p.plotWidth -
                    2 * v;
                p = p.plotHeight - 2 * v;
                var w = c.center;
                w = [F(w[0], "50%"), F(w[1], "50%"), c.size || "100%", c.innerSize || 0];
                var n = Math.min(y, p), l;
                for (l = 0; 4 > l; ++l) {
                    var b = w[l];
                    c = 2 > l || 2 === l && /%$/.test(b);
                ...
                return {start: G * (c + -90), end: G * (p + -90)}
            }
        }
    });
    M(J, "parts/PieSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = c.addEvent;
        p = c.CenteredSeriesMixin;
        var z = p.getStartAndEndRadians, r = c.merge, K = c.noop, v = c.pick, D = c.Point, w = c.Series,
            n = c.seriesType, l = c.setAnimation;
        n("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (b) {
                var d = this, a = d.points, c = d.startAngleRad;
                b || (a.forEach(function (a) {
                    var b = a.graphic, g = a.shapeArgs;
                    b && (b.attr({r: a.startR || d.center[3] / 2, start: c, end: c}), b.animate({
                        r: g.r,
                        start: g.start,
                        end: g.end
                    }, d.options.animation))
            ...
            updateTotals: function () {
                var b, d = 0, a = this.points, c = a.length, h = this.options.ignoreHiddenPoint;
                for (b = 0; b < c; b++) {
                    var e = a[b];
            ...
            getX: function (b, d, a) {
                var c = this.center, h = this.radii ? this.radii[a.index] : c[2] / 2;
                return c[0] + (d ? -1 :
            ...
            translate: function (b) {
                this.generatePoints();
                var d = 0, a = this.options, g = a.slicedOffset, h = g + (a.borderWidth || 0),
                    e = z(a.startAngle, a.endAngle), m = this.startAngleRad = e.start;
                e = (this.endAngleRad = e.end) - m;
                var l = this.points, n = a.dataLabels.distance;
                ...
                for (t = 0; t < p; t++) {
                    ...
                    k.slicedTranslation = {
                        translateX: Math.round(Math.cos(r) *
                            g), translateY: Math.round(Math.sin(r) * g)
                    };
                    ...
                    k.labelPosition = {
                        ...
                        connectorPosition: {
                            breakAt: {x: b[0] + w + Math.cos(r) * A, y: b[1] + q + Math.sin(r) * A},
                            touchingSliceAt: {x: b[0] + w, y: b[1] + q}
                        }
                    }
                }
            },
            ...
            redrawPoints: function () {
                var b = this, d = b.chart, a = d.renderer, c, h, e, m, l = b.options.shadow;
                ...
                b.points.forEach(function (g) {
                    ...
                    if (!g.isNull && h) {
                        ...
                        g.delayedRendering ? (h.setRadialReference(b.center).attr(m).attr(c), d.styledMode ||
            ...
            init: function () {
                ...
                var a = this, d = a.series, h = d.chart, e = d.options.ignoreHiddenPoint;
                c = v(c, e);
                b !== a.visible && (a.visible = a.options.visible =
                    b = void 0 === b ? !a.visible : b, d.options.data[d.data.indexOf(a)] = a.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function (c) {
                ...
                fixedOffset: function (b, c, a) {
                    ...
                    c.y, d.x, d.y] : ["L", d.x, d.y]).concat(["L", c.x, c.y])
                }, straight: function (b, c) {
                    c = c.touchingSliceAt;
                    return ["M", b.x, b.y, "L", c.x, c.y]
                }, crookedLine: function (b, d, a) {
                    d = d.touchingSliceAt;
                    var g = this.series, h = g.center[0], e = g.chart.plotWidth, m = g.chart.plotLeft;
                    g = b.alignment;
    ...
    M(J, "parts/DataLabels.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isArray, F = p.objectEach, z = p.splat, r = c.arrayMax, K = c.extend, v = c.format,
            D = c.merge;
        p = c.noop;
        var w = c.pick, n = c.relativeLength, l = c.Series, b = c.seriesTypes, d = c.stableSort;
        ...
        l.prototype.drawDataLabels = function () {
            ...
            function b(a, b) {
                ...
                if (G(a) && !G(b)) c = a.map(function (a) {
                    ...
                    return D(a, b)
                }); else if (G(a) || G(b)) for (d = Math.max(a.length, b.length); d--;) c[d] = D(a[d], b[d]); else c = D(a, b);
                return c
            }

            var d = this, e = d.chart, l = d.options, n = l.dataLabels,
                p = d.points, t, r = d.hasRendered || 0, k = c.animObject(l.animation).duration, A = Math.min(k, 200),
                B = !e.renderer.forExport && w(n.defer, 0 < A), H = e.renderer;
            ...
            if (G(n) || n.enabled || d._hasPointLabels) {
                ...
                B &&
                (q.attr({opacity: +r}), r || setTimeout(function () {
                    var a = d.dataLabelsGroup;
                    a && (d.visible && q.show(!0), a[l.animation ? "animate" : "attr"]({opacity: 1}, {duration: A}))
                }, k - A));
                p.forEach(function (c) {
                    ...
                    t.forEach(function (b, f) {
                        var g = b.enabled && (!c.isNull || c.dataLabelOnNull) && a(c, b),
                            ...
                            h = c.connectors ? c.connectors[f] : c.connector, m = w(b.distance, c.labelDistance),
                            t = !k;
                        if (g) {
        ...
        l.prototype.alignDataLabel = function (a, b, c, d, l) {
            var e = this.chart, g = this.isCartesian && e.inverted, h = w(a.dlBox &&
                a.dlBox.centerX, a.plotX, -9999), m = w(a.plotY, -9999), k = b.getBBox(), n = c.rotation, p = c.align,
            ...
            if (r) {
                ...
                if (c.shape && !n) b[l ? "attr" : "animate"]({
                    anchorX: g ? e.plotWidth -
                        a.plotY : a.plotX, anchorY: g ? e.plotHeight - a.plotX : a.plotY
                })
            }
            r || (b.hide(!0), b.placed = !1)
        };
        l.prototype.justifyDataLabel = function (a, b, c, d, l, n) {
            var e = this.chart, g = b.align, h = b.verticalAlign, k = a.box ? 0 : a.padding || 0;
            var m = c.x + k;
            if (0 > m) {
        ...
        b.pie && (b.pie.prototype.dataLabelPositioners = {
            ...
            var a = this, b = a.data, d, e = a.chart, m = a.options.dataLabels, n = m.connectorPadding, p,
                t = e.plotWidth, x = e.plotHeight, k = e.plotLeft, A = Math.round(e.chartWidth / 3), v, z = a.center,
                q = z[2] / 2, f = z[1], C, F, K, G, J = [[], []], L, I, M, Q, O = [0, 0, 0, 0],
                U = a.dataLabelPositioners, W;
            a.visible && (m.enabled || a._hasPointLabels) && (b.forEach(function (a) {
                ...
                a.dataLabel && (a.visible ? (J[a.half].push(a), a.dataLabel._pos = null, !y(m.style.width) && !y(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > A && (a.dataLabel.css({width: .7 * A}), a.dataLabel.shortened = !0)) : (a.dataLabel = a.dataLabel.destroy(), a.dataLabels && 1 === a.dataLabels.length && delete a.dataLabels))
                ...
                if (h) {
                    ...
                    for (Q = 0; Q < h; Q++) {
                        ...
                        if (m.justify) L = U.justify(d, q, z); else switch (m.alignTo) {
                            case "connectors":
                        ...
                        C._attr = {visibility: M, align: K.alignment};
                        C._pos = {
                ...
                if (p = w(W.connectorWidth, 1)) {
                    ...
                    v = b.connector;
                    if ((C = b.dataLabel) &&
                        C._pos && b.visible && 0 < b.labelDistance) {
            ...
            var b = this.center, c = this.options, d = c.center, l = c.minSize || 80, p = null !==
                c.size;
            if (!p) {
                if (null !== d[0]) var r = Math.max(b[2] - Math.max(a[1], a[3]), l); else r = Math.max(b[2] - a[1] - a[3], l), b[0] += (a[3] - a[1]) / 2;
    ...
    M(J, "modules/overlapping-datalabels.src.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.isArray, G = p.objectEach;
        p = c.Chart;
        var F = c.pick, z = c.addEvent, r = c.fireEvent;
        z(p, "render", function () {
            var c = [];
        ...
        p.prototype.hideOverlappingLabels = function (c) {
            var p = this, y = c.length, w = p.renderer, n, l, b;
            var d = function (a) {
                var b = a.box ?
                    0 : a.padding || 0;
                var c = 0;
            ...
            c.forEach(function (a) {
                ...
                if (a) {
                    ...
                    a.oldOpacity !== c && (a.alignAttr && a.placed ? (c ? a.show(!0) : b = function () {
                        a.hide(!0);
                        a.placed = !1
                    }, a.alignAttr.opacity = c, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, b), r(p, "afterHideOverlappingLabels")) : a.attr({opacity: c}));
                    a.isOld = !0
                }
            })
        }
    ...
    M(J, "parts/Interaction.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isArray, F = p.isObject, z = p.objectEach, r = c.addEvent;
        p = c.Chart;
        var K = c.createElement, v = c.css, D = c.defaultOptions, w = c.defaultPlotOptions, n = c.extend,
            l = c.fireEvent, b = c.hasTouch, d = c.Legend, a = c.merge, g = c.pick, h = c.Point, e = c.Series,
            m = c.seriesTypes, u = c.svg;
            ...
            drawTrackerPoint: function () {
                ...
                a._hasTracking || (a.trackerGroups.forEach(function (g) {
                    if (a[g]) {
                        ...
                        !c.styledMode && a.options.cursor && a[g].css(v).css({cursor: a.options.cursor})
                    }
                }), a._hasTracking =
                    !0);
                ...
                var a = this, c = a.options, d = c.trackByArea, e = [].concat(d ? a.areaPath : a.graphPath),
                    g = e.length, h = a.chart, m = h.pointer, f = h.renderer, n = h.options.tooltip.snap, p = a.tracker,
                    r, w = function () {
        ...
        n(d.prototype, {
            setItemEvents: function (b, c, d) {
                var e = this, g = e.chart.renderer.boxWrapper, k = b instanceof h,
                    m = "highcharts-legend-" + (k ? "point" : "series") + "-active", f = e.chart.styledMode;
        ...
        n(p.prototype, {
            showResetZoom: function () {
                ...
                var b = this, c = D.lang, d = b.options.chart.resetZoomButton, e = d.theme, g = e.states,
                ...
                var b = this, c, d = b.pointer, e = !1, h = b.inverted ? d.mouseDownX : d.mouseDownY;
                    ...
                    function () {
                        ...
                        ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
                            ...
                            var g = c[d], k = (b.pointRange || 0) / 2,
                                ...
                                l = b.getExtremes(), m = b.toValue(g - f, !0) + k * h;
        ...
        n(h.prototype, {
            select: function (a, b) {
                ...
                var c = this.series, d = this.state, e = c.options.states[a || "normal"] || {},
                    h = w[c.type].marker && c.options.marker, m = h && !1 === h.enabled,
                    f = h && h.states && h.states[a || "normal"] || {}, p = !1 === f.enabled, r = c.stateMarkerGraphic,
                    t = this.marker || {}, u = c.chart, x = c.halo, v, y = h && c.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === e.enabled || a && (p || m && !1 === f.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    ...
                    a && a.size && "hidden" !== e ? (x || (c.halo = x = u.renderer.path().add(r.parentGroup)), x.show()[b ? "animate" : "attr"]({d: this.haloPath(a.size)}), x.attr({
        ...
        n(e.prototype, {
            onMouseOver: function () {
                ...
                var a = this.options, b = this.chart, c = b.tooltip, d =
                    b.hoverPoint;
                b.hoverSeries = null;
                if (d) d.onMouseOut();
                ...
                var c = this, d = c.options, e = c.graph, h = d.inactiveOtherPoints, l = d.states, f = d.lineWidth,
                    m = d.opacity,
                ...
                if (c.state !== a && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (b) {
                    ...
                    if (e && !e.dashstyle) for (l = {"stroke-width": f}, e.animate(l, n); c["zone-graph-" + d];) c["zone-graph-" + d].attr(l), d += 1;
                ...
                var c = this, d = c.chart, e = c.legendItem, g = d.options.chart.ignoreHiddenSeries, h = c.visible;
    ...
    M(J, "parts/Responsive.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.isArray,
            G = p.isObject, F = p.objectEach, z = p.splat;
        p = c.Chart;
        var r = c.pick;
        p.prototype.setResponsive = function (p, r) {
            var v = this.options.responsive, w = [], n = this.currentResponsive;
        ...
        p.prototype.currentOptions = function (c) {
            function p(c, l, b, d) {
                var a;
                F(c, function (c, h) {
                    if (!d && -1 < r.collectionsWithUpdate.indexOf(h)) for (c = z(c), b[h] = [], a = 0; a < c.length; a++) l[h][a] && (b[h][a] = {}, p(c[a], l[h][a], b[h][a], d + 1)); else G(c) ? (b[h] = y(c) ? [] : {}, p(c, l[h] || {}, b[h], d + 1)) : b[h] = void 0 === l[h] ? null : l[h]
                })
            }
