...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'inputtypefield?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
						<fieldset><legend> InputTypeField</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("inputtypefield/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
