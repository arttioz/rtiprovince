...
<ul class="nav navbar-nav  navbar-right" >
    ...
    @if(Auth::check())
        ...
        <li><a href="{{ url('user/logout') }}"> ออกจากระบบ </a></li>
    @else

        <li><a href="{{ url('user/login') }}" onclick="SximoModal(this.href , 'ลงชื่อเข้าใช้');  return false;"> ลงชื่อเข้าใช้ </a></li>
        <li><a href="{{ url('user/register') }}" onclick="SximoModal(this.href , 'สมัครบัญชีผู้ใช้'); return false;"> สมัครบัญชีผู้ใช้ </a></li>
    @endif
