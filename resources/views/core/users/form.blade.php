...
{!! Form::open(array('url'=>'core/users?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
		<div class="col-md-6">
			...
			<div class="form-group ">
				...
				<label class=" control-label col-md-4 text-left"> สังกัดหน่วยงาน </label>
				<div class="col-md-6">
					<select name="department_id" class="form-control" required>
						<option value="" disabled selected>สังกัดหน่วยงาน</option>
						@foreach($departments as $department)

							<option @if($row['department_id'] == $department->id) selected @endif
							value="{{$department->id}}">
								{{$department->name}}
							</option>
						@endforeach
			...
			<div class="form-group ">
				...
				<label class=" control-label col-md-4 text-left"> ชื่อหน่วยงาน </label>
				<div class="col-md-6">
					<input name="section" type="text" class="form-control" placeholder="ชื่อหน่วยงาน"  value="{{$row['section']}}" required>
				</div>
				<div class="col-md-2"></div>
			...
			<div class="form-group ">
				...
				<label class=" control-label col-md-4 text-left"> จังหวัดของหน่วยงาน </label>
				<div class="col-md-6">
					<select name="province_id" id="select_province" class="form-control" required>
						...
						@foreach($locations as $location)
							...
							<option @if($row['province_id'] == $location->LOC_CODE) selected @endif
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  <input  type='file' name='avatar' id='avatar' @if($row['avatar'] =='') class='required' @endif style='width:150px !important;'  />
										 	<div >
											{!! SiteHelpers::showUploadedFile($row['avatar'],'/uploads/users/',"100%") !!}
