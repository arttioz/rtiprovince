...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'ritfiled?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
						<fieldset><legend> RITFiled</legend>
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#type_filed_id").jCombo("{!! url('ritfiled/comboselect?filter=type_filed:id:name') !!}",
		{  selected_value : '{{ $row["type_filed_id"] }}' });
		
		$("#input_type").jCombo("{!! url('ritfiled/comboselect?filter=input_type_field:id:name') !!}",
		{  selected_value : '{{ $row["input_type"] }}' });
		 		 

		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("ritfiled/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
