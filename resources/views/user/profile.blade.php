...
<div class="tab-content">
  <div class="tab-pane active m-t" id="info">
	{!! Form::open(array('url'=>'user/saveprofile/', 'class'=>'form-horizontal validated' ,'files' => true)) !!}  
	  ...
	  <div class="form-group">
		  <label for="ipt" class=" control-label col-md-4"> สังกัด </label>
		  <div class="col-md-8">
			  {{$department }}
		  </div>
	  </div>
	  ...
	  <div class="form-group">
		  <label for="ipt" class=" control-label col-md-4"> หน่วยงาน </label>
		  <div class="col-md-8">
			  {{$info->section}}
		  </div>
	  </div>
	  ...
	  <div class="form-group">
		  <label for="ipt" class=" control-label col-md-4"> จังหวัด </label>
		  <div class="col-md-8">
			  {{$location }}
		  </div>
	  </div>
